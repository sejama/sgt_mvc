        ...
        foreach ($partidosPlayOff as $tiposPlayOff) {
            foreach ($tiposPlayOff as $partidoPlayOff) {
                foreach ($partidoPlayOff as $playOff) {
                    ...
                    if (
                        isset($playOff['grupoEquipo1']) && isset($playOff['posicionEquipo1']) &&
                        isset($playOff['grupoEquipo2']) && isset($playOff['posicionEquipo2']) &&
                        !isset($playOff['equipoGanador1']) && !isset($playOff['equipoGanador2'])
                        ) {
                            if (
                                empty($playOff['grupoEquipo1']) || empty($playOff['posicionEquipo1']) || 
                                empty($playOff['grupoEquipo2']) || empty($playOff['posicionEquipo2'])) {
                                throw new AppException('Los equipos y sus posiciones son requeridos');
                            }
                            if (
                                !is_numeric($playOff['grupoEquipo1']) || !is_numeric($playOff['posicionEquipo1']) || 
                                !is_numeric($playOff['grupoEquipo2']) || !is_numeric($playOff['posicionEquipo2'])) {
                    ...
                    if (
                        ...
                        isset($playOff['equipoGanador1']) && isset($playOff['equipoGanador2'])
                            ...
                            if (!is_numeric($playOff['equipoGanador1']) || !is_numeric($playOff['equipoGanador2'])) {
                            throw new AppException('Los equipos ganadores deben ser números válidos');
                        }
    
                        if ($playOff['equipoGanador1'] === $playOff['equipoGanador2']) {
...
array(2) { 
    ["oro"]=> array(3) { 
        ["Cuartos de Final Oro"]=> array(4) { 
            [1]=> array(5) { ["nombre"]=> string(22) "Cuartos de Final Oro 1" 
                ["grupoEquipo1"]=> string(1) "1" ["posicionEquipo1"]=> string(1) "1" ["grupoEquipo2"]=> string(1) "3" ["posicionEquipo2"]=> string(1) "2" } 
            [2]=> array(5) { ["nombre"]=> string(22) "Cuartos de Final Oro 2" 
                ["grupoEquipo1"]=> string(1) "2" ["posicionEquipo1"]=> string(1) "1" ["grupoEquipo2"]=> string(1) "4" ["posicionEquipo2"]=> string(1) "2" }
            [3]=> array(5) { ["nombre"]=> string(22) "Cuartos de Final Oro 3" 
                ["grupoEquipo1"]=> string(1) "3" ["posicionEquipo1"]=> string(1) "1" ["grupoEquipo2"]=> string(1) "1" ["posicionEquipo2"]=> string(1) "2" } 
            [4]=> array(5) { ["nombre"]=> string(22) "Cuartos de Final Oro 4" 
                ["grupoEquipo1"]=> string(1) "4" ["posicionEquipo1"]=> string(1) "1" ["grupoEquipo2"]=> string(1) "2" ["posicionEquipo2"]=> string(1) "2" } } 
        ["Semi Final Oro"]=> array(2) { 
            [1]=> array(3) { ["nombre"]=> string(16) "Semi Final Oro 1" ["equipoGanador1"]=> string(1) "0" ["equipoGanador2"]=> string(1) "2" } 
            [2]=> array(3) { ["nombre"]=> string(16) "Semi Final Oro 2" ["equipoGanador1"]=> string(1) "1" ["equipoGanador2"]=> string(1) "3" } } 
        ["Final Oro"]=> array(1) { [1]=> array(3) { ["nombre"]=> string(11) "Final Oro 1" ["equipoGanador1"]=> string(1) "4" ["equipoGanador2"]=> string(1) "5" } } }
        
    ["plata"]=> array(3) { 
        ["Cuartos de Final Plata"]=> array(4) { 
            [1]=> array(5) { ["nombre"]=> string(24) "Cuartos de Final Plata 1" 
                ["grupoEquipo1"]=> string(1) "1" ["posicionEquipo1"]=> string(1) "9" ["grupoEquipo2"]=> string(1) "3" ["posicionEquipo2"]=> string(2) "10" } 
            [2]=> array(5) { ["nombre"]=> string(24) "Cuartos de Final Plata 2" 
                ["grupoEquipo1"]=> string(1) "2" ["posicionEquipo1"]=> string(1) "9" ["grupoEquipo2"]=> string(1) "4" ["posicionEquipo2"]=> string(2) "10" } 
            [3]=> array(5) { ["nombre"]=> string(24) "Cuartos de Final Plata 3" 
                ["grupoEquipo1"]=> string(1) "3" ["posicionEquipo1"]=> string(1) "9" ["grupoEquipo2"]=> string(1) "1" ["posicionEquipo2"]=> string(2) "10" } 
            [4]=> array(5) { ["nombre"]=> string(24) "Cuartos de Final Plata 4" 
                ["grupoEquipo1"]=> string(1) "4" ["posicionEquipo1"]=> string(1) "9" ["grupoEquipo2"]=> string(1) "2" ["posicionEquipo2"]=> string(2) "10" } } 
        ["Semi Final Plata"]=> array(2) { 
            [1]=> array(3) { ["nombre"]=> string(18) "Semi Final Plata 1" ["equipoGanador1"]=> string(1) "0" ["equipoGanador2"]=> string(1) "2" } 
            [2]=> array(3) { ["nombre"]=> string(18) "Semi Final Plata 2" ["equipoGanador1"]=> string(1) "1" ["equipoGanador2"]=> string(1) "3" } } 
