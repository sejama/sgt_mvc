...
final class Version20250306221853 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE partido_config (id INT AUTO_INCREMENT NOT NULL, partido_id INT NOT NULL, grupo_equipo1_id INT DEFAULT NULL, grupo_equipo2_id INT DEFAULT NULL, ganador_partido1_id INT DEFAULT NULL, ganador_partido2_id INT DEFAULT NULL, posicion_equipo1 SMALLINT DEFAULT NULL, posicion_equipo2 SMALLINT DEFAULT NULL, nombre VARCHAR(64) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_FB58ADC711856EB4 (partido_id), UNIQUE INDEX UNIQ_FB58ADC783ECE76 (grupo_equipo1_id, posicion_equipo1), UNIQUE INDEX UNIQ_FB58ADC71A8B6198 (grupo_equipo2_id, posicion_equipo2), UNIQUE INDEX UNIQ_FB58ADC7A1716C4E (ganador_partido1_id), UNIQUE INDEX UNIQ_FB58ADC7B3C4C3A0 (ganador_partido2_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
